...
public class Logger {
    ...
    private Logger() {
        // Enhanced for Selenium integration
        writeToFile("SYSTEM", "Logger started", "Selenium-powered application beginning");
    }
    ...
    private void writeToFile(String action, String link, String description) {
        try (FileWriter writer = new FileWriter(logFile, true)) {
            ...
            System.out.println("Logged: " + description + (link.isEmpty() ? "" : " for " + link));
        } catch (IOException e) {
